...
<div class="input-container">
    ...
    <div>
    <input type="submit" value="Employee Detail" class="searc"/>
    </div>
    </form>
     <form action="DeleteEmployee.jsp">
     <div>
    <input type="submit" value="Delete Employee" class="searc"/>
    </div>
    </form>
  <form action="UpdateProfile.jsp">
     <div>
    <input type="submit" value="Update Profile" class=searc"/>
    </div>
    </form>
