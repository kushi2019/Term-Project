...
<center>
  Employees Are
<table border="1">
<c:forEach var="employeeDetail"  items="${requestScope.empDetail}"  >
<tr style="background-color:#00CC00"><td><c:out value="${employeeDetail.getEmployeeId()}"></c:out></td>
<td><c:out value="${employeeDetail.firstName}"></c:out></td></font>
  </tr>  
</c:forEach>
</table></center>
<br>
